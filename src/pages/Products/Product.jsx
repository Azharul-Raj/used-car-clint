        ...
        <Link className="px-3 py-1 text-sm font-bold text-gray-100 transition-colors duration-300 transform bg-gray-600 rounded cursor-pointer hover:bg-gray-500" tabindex="0" role="button">Wishlist</Link>
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="lg:mx-5">
                    <div className="">
                        <p className='flex justify-start items-center  lg:font-bold lg:text-2xl'><FaCar/> <span className='ml-5'>{brand}</span> </p>
                        <p className='flex  justify-start items-center lg:font-bold lg:text-xl'><FaMapMarkerAlt/> <span className='ml-5'>{location}</span> </p>
                        <p className='flex justify-start items-center lg:font-bold lg:text-xl'> Original Price : <span className='ml-5'>{original_price}K$</span> </p>
                        <p className='flex  justify-start items-center lg:font-bold lg:text-xl'> Sale Price : <span className='ml-5'>{sale_price}k$</span> </p>
                        <p className='flex  justify-start items-center lg:font-bold lg:text-xl'>Condition : <span className='ml-5'>{condition}</span> </p>
                        <p className='flex  justify-start items-center lg:font-bold lg:text-xl'>Used : <span className='ml-5'>{used}/year</span> </p>
                    </div>
                </div>
        </div>
    <div className="mt-2">
