...
const BuyerDeleteModal = ({ buyerId,setBuyerId,refetch}:buyerDeleteModalProps) => {
...
<div className="modal">
  <div className="modal-box">
            <h3 className="font-bold text-lg">Are You Sure you will delete buyer?</h3>
    <p className="py-4">If You delete buyer it can't be retrieved</p>
    <div className="modal-action">
      <label onClick={()=>handleDelete(buyerId)} htmlFor="buyer-delete-modal" className="btn btn-sm bg-red-500 text-white">Delete</label>
